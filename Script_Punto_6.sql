...
ALTER TABLE servicios
ADD FOREIGN KEY (Id_PayPal)
REFERENCES paypal(Id);

ALTER TABLE servicios
ADD FOREIGN KEY (Id_Efectivo)
REFERENCES efectivos(Id);

ALTER TABLE servicios
ADD FOREIGN KEY (Id_detalle_factura)
REFERENCES detalles_facturas(Id);
...
--SELECT * FROM CIUDAD;
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('10101','Belle-Anse','1001');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('10202','Huddinge','1002');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('10303','Arcos','1003');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('10404','Piraí do Sul','1004');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('10505','El Real','1005');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('10606','Orito','1006');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('10707','El Tambo','1007');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('10808','Qa?anah','1008');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('10909','Hawassa','1009');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('11010','Segong','1010');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('11111','Eg-Uur','1011');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('11212','Cabanas de Viriato','1012');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('11313','El Fahs','1013');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('11414','Badaogu','1014');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('11515','San Francisco','1015');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('11616','Orahovica Donja','1016');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('11717','Bayanhoshuu','1017');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('11818','Lairoka','1018');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('11919','Kawangu Satu','1019');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('12020','Ararat','1020');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('12121','Kampong Chhnang','1021');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('12222','Tchamba','1022');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('12323','Júlio de Castilhos','1023');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('12424','?afas','1024');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('12525','Perniö','1025');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('12626','Liuqu','1026');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('12727','Aqtoghay','1027');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('12828','Suqin Huimin','1028');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('12929','Baopukang','1029');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('13030','Wilmington','1030');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('13131','Takub','1031');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('13232','Popielów','1032');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('13333','Banjing','1033');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('13434','Chai Badan','1034');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('13535','Caleta Olivia','1035');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('13636','Meybod','1036');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('13737','Shuanghe','1037');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('13838','Lourdes','1038');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('13939','Dingshan','1039');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('14040','Ngulahan','1040');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('14141','Rääkkylä','1041');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('14242','Lisewo','1042');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('14343','Cabinda','1043');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('14444','Cáceres','1044');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('14545','Phong ?i?n','1045');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('14646','That Phanom','1046');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('14747','Angol','1047');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('14848','Pirg','1048');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('14949','Caçador','1049');
Insert into CIUDADES (ID,CIUDAD,ID_PAIS) values ('15050','Samphanthawong','1050');
...
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('1','102945','12000','10121','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('6','108842','14000','10122','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('11','114739','20000','10123','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('16','120636','40000','10124','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('21','126533','44000','10125','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('26','132430','53000','10126','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('31','138327','62000','10127','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('36','144224','71000','10128','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('41','150121','80000','10129','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('46','156018','89000','10130','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('51','161915','98000','10131','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('56','167812','107000','10132','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('61','173709','116000','10133','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('66','179606','125000','10134','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('71','185503','134000','10135','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('76','191400','143000','10136','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('81','197297','152000','10137','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('86','203194','161000','10138','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('91','209091','170000','10139','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('96','214988','179000','10140','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('101','220885','188000','10141','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('106','226782','12000','10142','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('111','232679','14000','10143','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('116','238576','20000','10144','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('121','244473','224000','10145','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('126','250370','233000','10146','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('131','256267','12000','10147','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('136','262164','14000','10148','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('141','268061','20000','10149','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('146','273958','269000','10150','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('151','279855','278000','10151','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('156','285752','12000','10152','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('161','291649','14000','10153','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('166','297546','20000','10154','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('171','303443','314000','10155','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('176','309340','323000','10156','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('181','315237','332000','10157','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('186','321134','12000','10158','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('191','327031','14000','10159','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('196','332928','20000','10160','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('201','338825','368000','10161','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('206','344722','377000','10162','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('211','350619','386000','10163','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('216','356516','395000','10164','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('221','362413','404000','10165','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('226','368310','413000','10166','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('231','374207','12000','10167','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('236','380104','14000','10168','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('241','386001','20000','10169','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('246','391898','449000','10170','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('251','397795','458000','10171','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('256','403692','467000','10172','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('261','409589','476000','10173','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('266','415486','485000','10174','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('271','421383','494000','10175','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('276','427280','12000','10176','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('281','433177','14000','10177','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('286','439074','20000','10178','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('291','444971','530000','10179','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('296','450868','539000','10180','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('301','456765','548000','10181','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('306','462662','557000','10182','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('311','468559','566000','10183','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('316','474456','12000','10184','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('321','480353','14000','10185','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('326','486250','20000','10186','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('331','492147','602000','10187','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('336','498044','611000','10188','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('341','503941','620000','10189','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('346','509838','12000','10190','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('351','515735','14000','10191','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('356','521632','20000','10192','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('361','527529','656000','10193','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('366','533426','665000','10194','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('371','539323','674000','10195','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('376','545220','12000','10196','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('381','551117','14000','10197','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('386','557014','20000','10198','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('391','562911','710000','10199','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('396','568808','719000','10200','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('401','574705','728000','10201','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('406','580602','737000','10202','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('411','586499','746000','10203','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('416','592396','755000','10204','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('421','598293','12000','10205','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('426','604190','14000','10206','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('431','610087','20000','10207','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('436','615984','791000','10208','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('441','621881','800000','10209','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('446','627778','809000','10210','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('451','633675','818000','10211','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('456','639572','12000','10212','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('461','645469','14000','10213','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('466','651366','20000','10214','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('471','657263','854000','10215','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('476','663160','12000','10216','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('481','669057','14000','10217','False');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('486','674954','20000','10218','True');
Insert into SYSTEM.CODIGOS_PROMOCIONALES (ID,CODIGO_PROMOCIONAL,VALOR,ID_USUARIO,ESTADO) values ('491','680851','890000','10219','False');
...
Insert into EFECTIVOS (ID,ID_USUARIO) values ('200','10199');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('202','10200');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('204','10201');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('206','10202');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('208','10203');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('210','10204');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('212','10205');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('214','10206');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('216','10207');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('218','10208');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('220','10209');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('222','10210');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('224','10211');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('226','10212');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('228','10213');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('230','10214');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('232','10215');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('234','10216');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('236','10217');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('238','10218');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('240','10219');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('242','10220');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('244','10221');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('246','10222');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('248','10223');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('250','10224');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('252','10225');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('254','10226');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('256','10227');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('258','10228');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('260','10229');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('262','10230');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('264','10231');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('266','10232');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('268','10233');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('270','10234');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('272','10235');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('274','10236');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('276','10237');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('278','10238');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('280','10239');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('282','10240');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('284','10241');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('286','10242');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('288','10243');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('290','10244');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('292','10245');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('294','10246');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('296','10247');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('298','10248');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('300','10249');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('302','10250');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('304','10251');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('306','10252');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('308','10253');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('310','10254');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('312','10255');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('314','10256');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('316','10257');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('318','10258');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('320','10259');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('322','10260');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('324','10261');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('326','10262');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('328','10263');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('330','10264');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('332','10265');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('334','10266');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('336','10267');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('338','10268');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('340','10269');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('342','10270');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('344','10271');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('346','10272');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('348','10273');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('350','10274');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('352','10275');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('354','10276');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('356','10277');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('358','10278');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('360','10279');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('362','10280');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('364','10281');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('366','10282');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('368','10283');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('370','10284');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('372','10285');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('374','10286');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('376','10287');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('378','10288');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('380','10289');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('382','10290');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('384','10291');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('386','10292');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('388','10293');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('390','10294');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('392','10295');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('394','10296');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('396','10297');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('398','10298');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('400','10299');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('402','10300');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('404','10301');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('406','10302');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('408','10303');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('410','10304');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('412','10305');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('414','10306');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('416','10307');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('418','10308');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('420','10309');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('422','10310');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('424','10311');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('426','10312');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('428','10313');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('430','10314');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('432','10315');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('434','10316');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('436','10317');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('438','10318');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('440','10319');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('442','10320');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('444','10321');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('446','10322');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('448','10323');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('450','10324');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('452','10325');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('454','10326');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('456','10327');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('458','10328');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('460','10329');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('462','10330');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('464','10331');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('466','10332');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('468','10333');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('470','10334');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('472','10335');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('474','10336');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('476','10337');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('478','10338');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('480','10339');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('482','10340');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('484','10341');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('486','10342');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('488','10343');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('490','10344');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('492','10345');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('494','10346');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('496','10347');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('498','10348');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('500','10349');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('502','10350');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('504','10351');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('506','10352');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('508','10353');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('510','10354');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('512','10355');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('514','10356');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('516','10357');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('518','10358');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('520','10359');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('522','10360');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('524','10361');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('526','10362');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('528','10363');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('530','10364');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('532','10365');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('534','10366');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('536','10367');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('538','10368');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('540','10369');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('542','10370');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('544','10371');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('546','10372');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('548','10373');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('550','10374');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('552','10375');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('554','10376');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('556','10377');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('558','10378');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('560','10379');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('562','10380');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('564','10381');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('566','10382');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('568','10383');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('570','10384');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('572','10385');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('574','10386');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('576','10387');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('578','10388');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('580','10389');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('582','10390');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('584','10391');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('586','10392');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('588','10393');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('590','10394');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('592','10395');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('594','10396');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('596','10397');
Insert into EFECTIVOS (ID,ID_USUARIO) values ('598','10398');

-----------------------------Insercción de datos tabla Detalle_Factura------------------------------------------------------------

Insert into DETALLES_FACTURAS (ID,TARIFA_VIAJE,VALOR_OTROS_RECARGOS,VALOR_RESERVA,VALOR_PROPINAS) values ('4010','1038160','9538','1128319','800080');
Insert into DETALLES_FACTURAS (ID,TARIFA_VIAJE,VALOR_OTROS_RECARGOS,VALOR_RESERVA,VALOR_PROPINAS) values ('4011','1015002','4559','1475352','600057');
Insert into DETALLES_FACTURAS (ID,TARIFA_VIAJE,VALOR_OTROS_RECARGOS,VALOR_RESERVA,VALOR_PROPINAS) values ('4012','1148439','5729','13371,94','500005');
Insert into DETALLES_FACTURAS (ID,TARIFA_VIAJE,VALOR_OTROS_RECARGOS,VALOR_RESERVA,VALOR_PROPINAS) values ('4013','1191165','8453','1552722','300071');
Insert into DETALLES_FACTURAS (ID,TARIFA_VIAJE,VALOR_OTROS_RECARGOS,VALOR_RESERVA,VALOR_PROPINAS) values ('4014','1084964','8871','2018962','300021');
Insert into DETALLES_FACTURAS (ID,TARIFA_VIAJE,VALOR_OTROS_RECARGOS,VALOR_RESERVA,VALOR_PROPINAS) values ('4015','1009771','4069','1834283','300074');
Insert into DETALLES_FACTURAS (ID,TARIFA_VIAJE,VALOR_OTROS_RECARGOS,VALOR_RESERVA,VALOR_PROPINAS) values ('4016','1094741','8852','1026763','700004');
Insert into DETALLES_FACTURAS (ID,TARIFA_VIAJE,VALOR_OTROS_RECARGOS,VALOR_RESERVA,VALOR_PROPINAS) values ('4017','1130938','5041','16292,95','500089');
Insert into DETALLES_FACTURAS (ID,TARIFA_VIAJE,VALOR_OTROS_RECARGOS,VALOR_RESERVA,VALOR_PROPINAS) values ('4018','1172858','4005','1331110','600037');
Insert into DETALLES_FACTURAS (ID,TARIFA_VIAJE,VALOR_OTROS_RECARGOS,VALOR_RESERVA,VALOR_PROPINAS) values ('4019','1178857','4789','1459846','500029');
...
Insert into UBICACIONES (ID,LONGITUD,LATITUD,ID_SERVICIO) values ('3134','7,3732655','5,1215877','215');
Insert into UBICACIONES (ID,LONGITUD,LATITUD,ID_SERVICIO) values ('3136','-70,95','9,25','217');
Insert into UBICACIONES (ID,LONGITUD,LATITUD,ID_SERVICIO) values ('3138','31,1995755','-24,7237668','219');
Insert into UBICACIONES (ID,LONGITUD,LATITUD,ID_SERVICIO) values ('3140','113,83012','22,141482','202');
Insert into UBICACIONES (ID,LONGITUD,LATITUD,ID_SERVICIO) values ('